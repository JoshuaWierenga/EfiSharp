...
namespace System
{
    ...
    public abstract partial class Type : MemberInfo, IReflect
    {
        ...
        //TODO Add MemberFilter, EventInfo and GetEvents
        ...
        public virtual bool IsAssignableFrom([NotNullWhen(true)] Type? c)
        {
            ...
            if (toType != null && toType.IsRuntimeImplemented() == true)
        ...
        //TODO Add InvalidFilterCriteriaException, if this function is needed before full exception support then replace with closest exception
        // FilterAttribute
        ...
        //TODO Add StringComparision, InvalidFilterCriteriaException, ReadOnlySpan<T>, String.AsSpan
        // FilterName
