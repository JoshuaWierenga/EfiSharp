//From https://github.com/zenos-os/zenos/blob/33fac6b8/src/Zenos.CoreLib/System/Environment.Zenos.cs
//Updated for https://github.com/dotnet/corert/tree/0d45438
...
namespace System
{
    partial class Environment
    {
        ...
        {
            get => throw new NotImplementedException(); // Interop.Sys.GetCwd();
            set => throw new NotImplementedException(); // Interop.CheckIo(Interop.Sys.ChDir(value), value, isDirectory: true);
        }
...
//            return Path.Combine(homeDir, fallback);
        ...
        public static string[] GetLogicalDrives() => throw new NotImplementedException(); //Interop.Sys.GetAllMountPoints();
...
//                return dotPos == -1 ? hostName : hostName.Substring(0, dotPos);
        ...
        public static string NewLineConst => "\n";

        private static OperatingSystem GetOSVersion() => throw new NotImplementedException();  // GetOperatingSystem(Interop.Sys.GetUnixRelease());
        ...
        public static int SystemPageSize => throw new NotImplementedException();  // CheckedSysConf(Interop.Sys.SysConfName._SC_PAGESIZE);
