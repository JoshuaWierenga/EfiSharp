...
namespace System
{
    ...
    public partial class Random
    {
        ...
        public Random(int Seed) =>
            ...
            _impl = new Net5CompatDerivedImpl(this, Seed);
        ...
        private static void ThrowMinMaxValueSwapped() =>
            ...
            throw new ArgumentOutOfRangeException("minValue", SR.Argument_MinMaxValue);
        ...
        private static void AssertInRange(long result, long minInclusive, long maxExclusive)
        {
            ...
            {
                //TODO Add String.Format and Fix memory problems
                //Debug.Assert(result >= minInclusive && result < maxExclusive, $"Expected {minInclusive} <= {result} < {maxExclusive}");
                Debug.Assert(result >= minInclusive && result < maxExclusive, "Expect minInclusive <= result < maxExclusive");
            }
            else
            {
                //TODO Add String.Format and Fix memory problems
