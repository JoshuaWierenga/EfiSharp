...
*/
        ...
        //TODO Add ReadOnlySpan<T>, Span<T>, GlobalizationMode.Invariant, GlobalizationMode.UseNls, Char.IsHighSurrogate, Char.IsLowSurrogate
        //TODO Add SurrogateCasing.ToUpper and ToUpper
        ...
        //TODO Add GlobalizationMode.Invariant, GlobalizationMode.UseNls, Char.IsHighSurrogate, Char.IsLowSurrogate, OrdinalCasing.ToUpper
        //TODO Add CharUnicodeInfo.ToUpper and UnicodeUtility.GetScalarFromUtf16SurrogatePair
        /*internal static int CompareStringIgnoreCase(ref char strA, int lengthA, ref char strB, int lengthB)
        {
            ...
            while (index < length)
            {
                ...
                if (!char.IsHighSurrogate(a) || index >= lengthA - 1 ||
                    !char.IsLowSurrogate(lowSurrogateA = Unsafe.Add(ref charA, 1)))
                {
                    if (!char.IsHighSurrogate(b) || index >= lengthB - 1 ||
                ...
                uint upperSurrogateA =
                    CharUnicodeInfo.ToUpper(UnicodeUtility.GetScalarFromUtf16SurrogatePair(a, lowSurrogateA));
                uint upperSurrogateB =
                    CharUnicodeInfo.ToUpper(UnicodeUtility.GetScalarFromUtf16SurrogatePair(b, lowSurrogateB));
        ...
        //TODO Add ReadOnlySpan<T>, GlobalizationMode.Invariant, GlobalizationMode.UseNls, MemoryMarshal.GetReference, Char.IsHighSurrogate
        //TODO Add ToUpper, Char.IsLowSurrogate and SurrogateCasing.Equal
        ...
        //TODO Add s_casingTableInit and s_noCasingPage
        ...
        //TODO Add Interop.Globalization, Volatile and s_casingTable
