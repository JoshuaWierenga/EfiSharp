...
public static class GenericVirtualMethods
{
    ...
    public static void TestConstrainedCalls<T>(T t, string intString, string derivedClassString, string stringString)
    ...
    public static void TestCalls()
    {
        ...
        d = igvm.GVM<string>;
        Assert.AreEqual("Called Derived.GVM<string>", d("testString"));
        TestConstrainedCalls<IInterfaceWithGVM>(igvm, "Called Derived.GVM<int>", "Called Derived.GVM<GVMDerivedClass>",
        ...
        TestConstrainedCalls<GVMStruct>(new GVMStruct(), "Called GVMStruct.GVM<int>",
            "Called GVMStruct.GVM<GVMDerivedClass>", "Called GVMStruct.GVM<string>");
        TestConstrainedCalls<IInterfaceWithGVM>(new GVMStruct(), "Called GVMStruct.GVM<int>",
            "Called GVMStruct.GVM<GVMDerivedClass>", "Called GVMStruct.GVM<string>");
        ...
        Assert.AreEqual("Called GVMStructGeneric<int>.GVM<GVMDerivedClass>",
        ...
        TestConstrainedCalls<GVMStructGeneric<int>>(new GVMStructGeneric<int>(),
            "Called GVMStructGeneric<int>.GVM<int>", "Called GVMStructGeneric<int>.GVM<GVMDerivedClass>",
            "Called GVMStructGeneric<int>.GVM<string>");
        TestConstrainedCalls<IInterfaceWithGVM>(new GVMStructGeneric<int>(), "Called GVMStructGeneric<int>.GVM<int>",
            "Called GVMStructGeneric<int>.GVM<GVMDerivedClass>", "Called GVMStructGeneric<int>.GVM<string>");
        ...
        Assert.AreEqual("Called GVMStructGeneric<object>.GVM<GVMDerivedClass>",
            igvmStructGenericOverObject.GVM<GVMDerivedClass>(testObject));
        Assert.AreEqual("Called GVMStructGeneric<object>.GVM<string>",
        ...
        TestConstrainedCalls<IInterfaceWithGVM>(new GVMStructGeneric<object>(),
            "Called GVMStructGeneric<object>.GVM<int>", "Called GVMStructGeneric<object>.GVM<GVMDerivedClass>",
    ...
    {
        GenericTypeWithThreeParameters<int, string, object> o =
            new GenericTypeWithThreeParameters<int, string, object>(123);
        ...
        GenericTypeWithThreeParameters<int, string, Type> o2 =
            new GenericTypeWithThreeParameters<int, string, Type>(123);
        ...
        Assert.AreNotEqual(System.Reflection.RuntimeReflectionExtensions.GetMethodInfo(d),
        ...
        Func<object, bool> d7 = ClassWithGenericMethod
            .MethodWithTwoGenericParametersWhereOnlyTheFirstIsUsed<object, string>;
        Func<object, bool> d8 = ClassWithGenericMethod
            .MethodWithTwoGenericParametersWhereOnlyTheFirstIsUsed<object, Type>;
        ...
        Assert.AreNotEqual(System.Reflection.RuntimeReflectionExtensions.GetMethodInfo(d7),
        ...
        Assert.AreNotEqual(System.Reflection.RuntimeReflectionExtensions.GetMethodInfo(d3),
        ...
        Assert.AreNotEqual(System.Reflection.RuntimeReflectionExtensions.GetMethodInfo(d5),
