...
//TODO Add Object.ReferenceEquals
/*class TestLdstr
{
...
//TODO Fix crash with s_byteStarArray
...
//TODO Fix crash, using this function results in hyperv and virtualbox black screening but not stopping the vm
...
static class TestRelationalOperators
{
    ...
    static TestRelationalOperators()
    {
        if (s_zeroInt > 0)
            //throw new Exception();
            Console.WriteLine("TestRelationOperators test 1 failed");
        if (s_zeroInt < 0)
            //throw new Exception();
            Console.WriteLine("TestRelationOperators test 2 failed");
        if (s_zeroInt >= 0 && s_zeroInt <= 0)
        {
            if (s_zeroLong > 0)
                //throw new Exception();
                Console.WriteLine("TestRelationOperators test 3 failed");
            if (s_zeroLong < 0)
                //throw new Exception();
                Console.WriteLine("TestRelationOperators test 4 failed");
            if (s_zeroLong >= 0 && s_zeroLong <= 0)
            {
                if (s_zeroDouble > 0)
                    //throw new Exception();
                    Console.WriteLine("TestRelationOperators test 5 failed");
                if (s_zeroDouble < 0)
                    //throw new Exception();
                    Console.WriteLine("TestRelationOperators test 6 failed");
                if (s_zeroDouble >= 0 && s_zeroDouble <= 0)
                {
                    if ((uint)s_minusOneInt < (uint)s_zeroInt)
                        //throw new Exception();
                        Console.WriteLine("TestRelationOperators test 7 failed");
                    if ((uint)s_zeroInt > (uint)s_minusOneInt)
                        //throw new Exception();
                        Console.WriteLine("TestRelationOperators test 8 failed");
                    if ((ulong)s_minusOneLong < (ulong)s_zeroLong)
                        //throw new Exception();
                        Console.WriteLine("TestRelationOperators test 9 failed");
                    if ((ulong)s_zeroLong > (ulong)s_minusOneLong)
                        //throw new Exception();
                        Console.WriteLine("TestRelationOperators test 10 failed");
...
//TODO Fix throw and try finally, using this function results in hyperv and virtualbox black screening but not stopping the vm
    ...
    static TestTryFinally()
    {
        try
        {
            if (new byte[0].Length > 0)
                //throw new Exception();
                Console.WriteLine("TestTryFinally test 1 failed");
        }
        finally
        {
            s_cookie = 1985;
...
//Why would this ever throw?
//TODO Fix throw, if this is modified to throw then the linker fails
class TestTryCatch
{
    static int s_cookie;
...
//TODO Add ThrowTypeLoadException
class TestBadClass
{
...
static class Assert
{
    //TODO Add Type.GetConstructor, BindingFlags and Type.EmptyTypes
    ...
    public static unsafe void AreEqual(void* v1, void* v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual void* Failed");
    }
    ...
    public static unsafe void AreEqual(bool v1, bool v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual bool Failed");
    }
    ...
    public static unsafe void AreEqual(int v1, int v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual int Failed");
    }
    ...
    public static unsafe void AreEqual(long v1, long v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual long Failed");
    }
    ...
    public static unsafe void AreEqual(float v1, float v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual float Failed");
    }
    ...
    public static unsafe void AreEqual(double v1, double v2)
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreEqual double Failed");
    }
    ...
    public static void True(bool v)
    {
        if (!v)
            //throw new Exception();
            Console.WriteLine("Assert True Failed");
    }
    ...
    public static void AreSame<T>(T v1, T v2) where T : class
    {
        if (v1 != v2)
            //throw new Exception();
            Console.WriteLine("Assert AreSame<T> Failed");
    }
}
