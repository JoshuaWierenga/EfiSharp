...
public class BringUpTest
{
    ...
    public static void Main()
    {
        ...
        if (TestMultipleInterfaces() == Fail)
            //return Fail;
            Console.WriteLine("TestMultipleInterfaces test failed");
        ...
        if (TestIterfaceCallOptimization() == Fail)
            //return Fail;
            Console.WriteLine("TestIterfaceCallOptimization test failed");
    ...
    private static int TestMultipleInterfaces()
    {
        ...
        if (myInterface.GetAString() != "TestClass")
        {
    ...
    //TODO Add String.Empty, IEumerable<string>, IList
    ...
    //TODO Support Default Interface Implementation
